<x-app-layout>
    ...
    <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg dark:bg-gray-800">
        <div class="max-w-xl">
            <section>
                <form method="post" action="{{ route('client.user-packages.update') }}" class="mt-6 space-y-6"
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input id="user_id" name="user_id" type="hidden" class="block w-full"
                            :value="old('user_id', $userPackage->user_id)" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input id="title" name="title" type="text" class="block w-full"
                            :value="old('price', $userPackage->title)" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input id="price" name="price" type="number" class="block w-full"
                            :value="old('price', $userPackage->price)" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <x-form.input id="duration" name="duration" type="text" class="block w-full"
                            :value="old('duration', $userPackage->duration)" required />
                    ...
                    <div class="space-y-2">
                        ...
                        <option value="1" {{ old('available', $userPackage->available) == 1 ? 'selected' : '' }}>
                                {{ __('Yes') }}
                            </option>
                            <option value="0" {{ old('available', $userPackage->available) == 0 ? 'selected' : '' }}>
                                {{ __('No') }}
                            </option>
                        </select>
