...
<body class="font-sans antialiased dark:bg-black dark:text-white/50 h-screen w-screen" <section
    ...
    <div
        class="container mx-auto relative z-20 flex flex-col gap-8 items-center justify-center px-4 md:px-0 text-center h-full">
        <div class="space-y-4">
            <h1 class="text-6xl font-bold text-white relative z-20">
                Meet Your
                <span class="text-white bg-pink px-4 py-2 rounded-xl">
                    Lovely
                </span>
                Partner
            </h1>
            <h2 class="text-3xl font-bold text-white relative z-20">
